...
function search() { 
  ...
  //clear and fill in recipes
  recipesContainer.innerHTML = "";
  sortedRecipes.forEach(function(recipe){renderRecipe(recipe);})
}
...
function recipeTemplate(recipe) {
  return `<section class="recipe">
        <div class="image"><img src="${recipe.image}" alt="${recipe.name}" /></div>
